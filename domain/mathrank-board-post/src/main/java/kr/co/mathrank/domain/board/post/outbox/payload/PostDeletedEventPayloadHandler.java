...
@Component
class PostDeletedEventPayloadHandler implements PostEventPayloadHandler<Post> {
	@Override
	public String createPayload(Post post, Long eventId) {
		final PostDeletedEventPayload payload = new PostDeletedEventPayload(eventId, post.getId(), post.getTitle(),
	...
	public record PostDeletedEventPayload(Long eventId, String postId, String title, String content, Long ownerId,
