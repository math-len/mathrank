...
class AssessmentTest {
	...
	void 시험지_생성시_문항들은_1번부터_순서대로_등록된다() {
		...
		// 시험 문제 번호
		assessment.updateAssessmentItems(List.of(345L, 212L, 120232L, 1221323L), List.of(25, 25, 25, 25));
	...
	void 시험지내_문제_수정은_전체를_바꿔야한다() {
		...
		// 새로운 문제들로 변경
		assessment.updateAssessmentItems(List.of(1212L, 2222L, 3333L), List.of(25, 25, 50));
	...
	void 트랜잭션_안에서_문항_변경시_DB_정상반영() {
		...
		reloadedAssessment.updateAssessmentItems(List.of(1L, 2L, 3L), List.of(25, 25, 50));
		entityManager.flush();
		entityManager.clear();
